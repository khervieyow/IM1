...
<div class="container"  style="background:rgba(146,220,233,255)">
    ...
    <a href="addcateg.php" class="btn btn-light">Show Categories</a>
</div>
    </form>
    ...
    <form action="" method="POST" class="row g-3">
        ...
        <div class="col-md-12">
            ...
            <button type="submit" name="reset" class="btn btn-secondary" style="margin-left: 20px;">Refresh</button> 
                ...
                foreach ($result as $row) { ?>
                    <tr>
                        ...
                        <form action="" method="POST">
                           <td> <button type="submit" name="delete_product" value="<?php echo $row->id; ?>" class="btn btn-danger">Delete</button>
                        </form>
                    </td>
                    </tr>
            <?php }
